...
| Elasticsearch | search / operational index | query-based snapshot and incremental baseline | adapter contract, config surface, live ping, tracked-index introspection, snapshot baseline, and local full-cycle proof export implemented |
