...
| ScyllaDB | yes | yes | no | no | no | no | no | dedicated adapter alias over the Cassandra-compatible snapshot baseline with local full-cycle proof export and deployment guidance, ready for deeper validation later |
